...
class Application_Form_GeneralCompany extends Zend_Form {
    ...
    public function init() {
        ...
        $this->addElement('text', 'tel', array('label'=> $functions->T('tel_mobiel'),'size' => 50, required => false));
        $this->addElement('text', 'vatnr', array('label'=> $functions->T('ondernemingsnummer'),'size' => 50, required => false));
        //$this->addElement('select', 'nr_clients', array('label'=> $functions->T('actieve_klanten')."",'MultiOptions' => $functions->texttolist('actieve_klanten_lijst')));
        //$this->addElement('radio', 'type_clients', array('label'=> $functions->T('samenstelling_klanten')."" ,'MultiOptions' => $functions->texttolist('typeklanten_lijst',false)));
        $this->addElement('select', 'sector', array('label'=> $functions->T('sector')."" ,'MultiOptions' => $functions->texttolist('sector_lijst'), required => false));
